                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="name"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Nom et prénoms:') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="number"
                                        ...
                                        autocomplete="phone_number" placeholder="+XXXXXXXXXXX">
                            ...
                            <!-- <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="file"
                                        class="form-control @error('profile_photo_path') is-invalid @enderror"
                                        name="profile_photo_path" value="{{ old('profile_photo_path') }}" required>
...
-->
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Confirmez mot de passe:') }}</label>
