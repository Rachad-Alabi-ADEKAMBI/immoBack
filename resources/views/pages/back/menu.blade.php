...
<div class="menu">
    ...
    <div class="menu__mobile">
        <div class="menu__mobile__show" id="showMenu">
            <i class="fas fa-chevron-down" onclick=showMenu()></i>
        </div>

        <div class="menu__mobile__close" id="closeMenu">
            <i class="fas fa-chevron-up" onclick=closeMenu()></i>
        </div>
