            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12">
                        ...
                        <span>a.</span> Vous devez avoir au moins 18 ans pour utiliser le site, ou avoir l'âge de la
                        majorité
                        dans votre juridiction si celui-ci est supérieur à 18 ans. <br>

                        <span> b.</span> Vous acceptez de fournir des informations exactes et à jour lors de votre
                        inscription sur
                        le site. <br>

                        <span>c.</span> Vous êtes responsable de la confidentialité de votre compte et de vos
                        informations
                        d'identification. Toute activité effectuée sous votre compte est de votre responsabilité.
                        <br>

                        <span>d.</span> Vous acceptez de ne pas utiliser le site à des fins illégales, diffamatoires,
                        offensantes, ou pour toute autre activité contraire à l'éthique.<br>
                        ...
                        <span>b.</span> Nous nous réservons le droit de supprimer tout contenu jugé inapproprié ou non
                        conforme à
                        nos politiques sans préavis. <br>

                        <span>c.</span> Nous ne pouvons garantir l'exactitude, la qualité ou la légalité des biens
                        annoncés sur
                        le site. Les utilisateurs doivent faire preuve de diligence raisonnable avant de conclure
                        des transactions.
                        </p> <br> <br>

                        <h2 class="subtitle">
                            3- Utilisation responsable du site :
                        </h2> <br>
                        ...
                        <p class="text text-left">
                            ...
                            illégales, trompeuses, frauduleuses ou nuisibles à autrui. <br>
                            <span>c.</span> Vous acceptez de ne pas interférer avec le fonctionnement normal du site, y
                            compris en utilisant des logiciels, des robots, des scripts ou d'autres méthodes
                            automatisées pour accéder ou collecter des données à partir du site sans notre autorisation
                            expresse.

                        </p> <br><br>

                        <h2 class="subtitle">
                            Responsabilité de l'exactitude du contenu :
                        </h2> <br>
                        ...
                        <h2 class="subtitle">
                            4- Suspension ou résiliation du compte :
                        </h2> <br>

                        <p class="text text-left">
                            <span>a. </span> Nous nous réservons le droit de suspendre ou de résilier votre compte,
                            temporairement ou définitivement, si nous constatons une violation des présentes CGU, de la
                            politique de confidentialité, ou des lois en vigueur au Bénin. <br>
                            <span>b. </span> En cas de suspension ou de résiliation, vous ne serez pas autorisé à créer
                            un nouveau compte sans notre autorisation préalable.
                            <br>
                        </p>
                        ...
                        <p class="text text-left">
                            ...
                            de confidentialité ou des droits de tiers.
