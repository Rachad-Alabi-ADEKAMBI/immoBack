<div class="pt-5">
    <x-form-section submit="updateProfileInformation ">
        ...
        <x-slot name="description">
            {{ __('Vous pouvez modifier les informations de votre compte') }}
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <p class="text-sm mt-2">
                    {{ __("Votre email n'a pas été vérifié.") }}
        ...
        <x-slot name="actions">
            ...
            <x-button wire:loading.attr="disabled" wire:target="photo" class="btn btn-success">
                {{ __('Enregistrer') }}
            </x-button>
        </x-slot>
    </x-form-section>
