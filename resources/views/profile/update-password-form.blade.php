<x-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __("Nous vous recommandons d'utiliser un mot de passe long et difficile à deviner pour plus de sécurité") }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('Connfirmez le mot de passe') }}" />
